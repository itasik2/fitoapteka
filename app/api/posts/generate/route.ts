...
Никаких "Вопрос:"/"Ответ:" и не в одну строку. Между парами — пустая строка.`
    ...
    const prompt = `
Ты — редактор и эксперт по фитопродуктам и wellness-товарам для интернет-магазина фитоаптеки.
      ...
      messages: [
        {
          role: "system",
          content:
            "Ты пишешь статьи для блога фитоаптеки и магазина wellness-товаров. Всегда возвращаешь строго JSON, без текста вне JSON.",
        },
